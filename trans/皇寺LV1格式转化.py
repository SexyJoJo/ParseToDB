    ...
    for root, _, files in os.walk(PATH):
        for file in files:
            if file.endswith('LV1.csv'):
                ...
                # 保存文件
                if not os.path.exists(rf'D:\Data\microwave radiometer\Measured brightness temperature\53798皇寺\{ymd}'):
                    os.makedirs(rf'D:\Data\microwave radiometer\Measured brightness temperature\53798皇寺\{ymd}')
                save_path = rf'D:\Data\microwave radiometer\Measured brightness temperature\53798皇寺\{ymd}\Z_UPAR_I_53798_{ymd_hms}_O_YMWR_HUANGSI_RAW_D.txt'
                ...
                with open(save_path, 'r+', encoding='utf-8') as f:
                    ...
                    f.seek(0, 0)
                    f.write('MWR,01.00\n')
                    f.write(f'53798,114.3589,37.1808,183.0,HUANGSI,22,83\n')
                    f.write(old)
